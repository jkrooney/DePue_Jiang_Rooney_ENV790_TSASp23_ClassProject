...
# show top 10 rows of data
   ...
   knitr::kables(
     list(knitr::kable(d1, col.names=c("Date","$/Mcf"),valign = 't'
    ),
   
    # the second kable() to set the digits option
    knitr::kable(d2, col.names=c("Date","Cents/kWh"),digits = 2, valign = 't')
  ),
  caption = 'First 10 rows of Electricy & Natural Gas Datasets')
```
...
```{r plot initial time series, echo=FALSE}
